defmodule ElixirSqlite.CatalogTest do
  use ElixirSqlite.DataCase

  alias ElixirSqlite.Catalog

  describe "products" do
    alias ElixirSqlite.Catalog.Product

    import ElixirSqlite.CatalogFixtures
  ...
  describe "categories" do
    alias ElixirSqlite.Catalog.Category
