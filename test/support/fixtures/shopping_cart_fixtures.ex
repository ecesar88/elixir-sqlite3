defmodule ElixirSqlite.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `ElixirSqlite.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> ElixirSqlite.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> ElixirSqlite.ShoppingCart.create_cart_item()
