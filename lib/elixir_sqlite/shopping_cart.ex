defmodule ElixirSqlite.ShoppingCart do
  @moduledoc """
  ...
  alias ElixirSqlite.Catalog
  alias ElixirSqlite.ShoppingCart.Cart
  alias ElixirSqlite.ShoppingCart.{Cart, CartItem}
  ...
  alias ElixirSqlite.ShoppingCart.CartItem
